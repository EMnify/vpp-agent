...
const (
	...
	Interface_IPSEC_TUNNEL      Interface_Type = 8 // Deprecated: Do not use.
...
type GtpuLink struct {
	...
	// Kept for backward compatibility, use src_teid and dst_teid instead.
	...
	// Local Tunnel endpoint identifier (locally assigned, seen in incoming packets)
	SrcTeid uint32 `protobuf:"varint,7,opt,name=src_teid,json=srcTeid,proto3" json:"src_teid,omitempty"`
	// Remote Tunnel endpoint identifier (remotely assigned, set in outgoing packets)
	DstTeid              uint32   `protobuf:"varint,8,opt,name=dst_teid,json=dstTeid,proto3" json:"dst_teid,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GtpuLink) GetSrcTeid() uint32 {
	if m != nil {
		return m.SrcTeid
	}
	return 0
...
func (m *GtpuLink) GetDstTeid() uint32 {
	if m != nil {
		return m.DstTeid
	}
	return 0
...
var fileDescriptor_8b053108eedee97b = []byte{
	...
	,
}
